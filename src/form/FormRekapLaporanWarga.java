 ...
 * @author galih
 */
public class FormRekapLaporanWarga extends javax.swing.JDialog {
    ...
    public FormRekapLaporanWarga(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void cari(){
        ...
        String jenisLaporan = jenisLaporanCB.getSelectedItem().toString();        
        ...
        String sql = "SELECT * FROM form_laporan where tgllapor BETWEEN ? AND ? AND jenislaporan = ? ";
    ...
    public void cetak(){
        ...
        JasperPrint jasperPrint = null;
         ...
         try {
            URL url = getClass().getResource("/report/rpt_rekap_laporan.jrxml");
            ...
            param.put("jenis", jenisLaporanCB.getSelectedItem().toString());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("REKAP LAPORAN WARGA");
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(jenisLaporanCB, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(fromDateField, javax.swing.GroupLayout.DEFAULT_SIZE, 208, Short.MAX_VALUE)))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(toDateField, javax.swing.GroupLayout.PREFERRED_SIZE, 201, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel3Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {fromDateField, jButton4, jenisLaporanCB});
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormRekapLaporanWarga.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
